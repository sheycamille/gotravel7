...
@section('content')
    ...
    <div id="finder" class="js-sticky sticky-sm z-2-sm bg-white pv2 bb b--gray-15" style="top: 0">
        <div class="container rideshare pv2 ph3 ph4-sm">
            ...
            <form id="quicksearch" target="_parent" class="search-form flex-md" action="{{ route('rides') }}"
                ...
                <div class="form-group o-mb4 o-mb0-md o-mr3-md flex-grow-md">
                    <span class="js-autocompleter">
                        <input id="pickup" class="js-autocompleted search-form__control input-lg with-icon places-search"
                            name="pickup" placeholder="@lang('page.current_location')" type="text" tabindex="1" autocomplete="off"
                            value="{{ $pickup }}">
                    </span>
                </div>
                ...
                <div class="form-group o-mb4 o-mb0-md o-mr3-md flex-grow-md">
                    <span class="js-autocompleter">
                        <input id="destination"
                            class="js-autocompleted search-form__control input-lg with-icon icon-to places-search"
                            name="destination" placeholder="Destination..." type="text" tabindex="2" autocomplete="off"
                            value="{{ $destination }}">
                    </span>
                </div>
                ...
                <div class="date-time-picker date-time-picker--rideshare o-mr2">
                    <div class="date-time-input">
                        <input type="text" id="datetime1" value="{{ old('date') }}" name="date"
                            class="js-datepicker datepicker date-time-input__date search-form__control input-lg with-icon--sm hasDatepicker"
                            tabindex="3" placeholder="Date">
                        <input type="text" id="datetime2" value="{{ old('time') }}" name="time"
                            class="date-time-input__time search-form__control input-lg with-icon--sm hours ui-timepicker-input"
                            tabindex="4" autocomplete="off" placeholder="Time">
                    </div>
                </div>

                <div class="form-group o-mb4 o-mb0-md o-mr3-md flex-grow-md">
                    <div class="js-autocompleter">
                        <select class="search-form__control input-lg" id="type" type="text"
                            value="{{ old('type') }}" name="type" required tabindex="5"
                            placeholder="transport persons or goods">
                            <option value="">For...</option>
                            <option @if (\Session::get('transport') == 'persons') selected="selected" @endif value="persons">Persons
                            </option>
                            <option @if (\Session::get('transport') == 'goods') selected="selected" @endif value="goods">Goods
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="search-wrapper">
                    <input class="search-form__btn btn btn-primary btn-lg submitter"
                        data-url="{{ route('rides', 'persons') }}" tabindex="6" value="Search rides" type="submit">
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="col-sm-10">
                    ...
                    <div class="card new-type mb4 mb5-sm pa5 flex">
                        <div class="mr4">
                            <img width="48" height="48" class="media-object"
                                src="{{ URL::to('assets/images') }}/icon_points_badge_green.png" alt="Gokamz Points">
                        </div>
                        <div>
                    ...
                    <div id="rides">
                        <ul class="list-unstyled">
                                    ...
                                    <a class="link-unstyled" href="{{ route('details-ride', $ride->id) }}">
                                        <div class="flex-sm">
                                            ...
                                            <div
                                                ...
                                                <div class="pa4-sm flex flex-align-center flex-1 flex-order-2-sm">
                                                    {{-- <span title="" data-toggle="tooltip" data-placement="top"
                                                        ...
                                                        @foreach (array_fill(0, $ride->spacesLeft(), 1) as $index)
                                                            <img alt="{{ $ride->num_of_seats }} seats left"
                                                                class="icon-seat"
                                                ...
                                                <div
                                                    class="pa4-sm flex-sm flex-justify-center flex-align-center flex-1 flex-order-1-sm w-100% f4 bb-sm b--gray-7 tright uppercase bold tcenter-sm">
                                                    XAF {{ $ride->cost }}
                                                </div>
                                            </div>
                                            <div
                                                ...
                                                <div class="mw-100% tcenter-sm">
                                                    <div class="flex flex-column-sm">
                                                        ...
                                                        <div class="lh-solid top" data-placement="top"
                            ...
                            @empty
                                <div class="card new-type mb4 mb5-sm pa5 flex">
                                    <p class="text-danger " style="font-size:20px; color:#4cc417;">Sorry we could not find
                                        any rides for your destination, please wait for some few hours and try again. Thanks
